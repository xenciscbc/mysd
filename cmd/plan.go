...
func runPlan(cmd *cobra.Command, args []string) error {
	...
	if planContextOnly {
		...
		ctx := map[string]interface{}{
			...
			"model":                    config.ResolveModel("planner", cfg.ModelProfile, cfg.ModelOverrides, cfg.CustomProfiles),
			"reviewer_model":           config.ResolveModel("reviewer", cfg.ModelProfile, cfg.ModelOverrides, cfg.CustomProfiles),
			"plan_checker_model":       config.ResolveModel("plan-checker", cfg.ModelProfile, cfg.ModelOverrides, cfg.CustomProfiles),
